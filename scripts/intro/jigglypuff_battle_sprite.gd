...
const SFX_INDEX: Dictionary = {
	"HIP": preload(INTRO_SFX_PATH + "SFX_INTRO_HIP" + SFX_FILE_EXTENSION),
	"HOP": preload(INTRO_SFX_PATH + "SFX_INTRO_HOP" + SFX_FILE_EXTENSION),
	"LUNGE": preload(INTRO_SFX_PATH + "SFX_INTRO_LUNGE" + SFX_FILE_EXTENSION),
}
